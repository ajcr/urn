...
class Output:
    ...
    def output(self, computation: Computation, evaluation: Sequence[Rational]) -> str:
        """Create output."""
    ...
    def make_table(self, computation: Computation, evaluation: Sequence[Rational]) -> str:
    ...
    def make_plot(self, computation: Computation, evaluation: Sequence[Rational]) -> str:
